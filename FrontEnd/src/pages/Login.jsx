...
const Login = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4
                        justify-center rounded-md sm:w-[600px] sm:h-[450px]"
        >
          <h1
            className={
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5 w-full">
            ...
            <div className="flex flex-col gap-2">
              ...
              />
                      ...
                      <button className="bg-[#d6482b] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white w-[280px] mx-auto lg:[640px] md-4"
                          type="Submit">
                          Login
