    ...
    <>
      ...
      >
        <div>
          ...
          <h1
            className={
              "text-[#111]text-2xl font-bold md-2 min-[480px]:text-4xlmd:text-6xl xl:text-7xl 2xl:text-8xl"
            }
          >
          ...
          <div className="flex gap-4 my-8">
            {!isAuthenticated && (
              <>
                ...
                <Link
                  to={"/login"}
                  className="text-[#DECCBE] bg-transparent border-[#DECCBE] hover:bg-[#fff3fd] hover:text-[#fdba88] font-bold text-xl rounded-md px-8 flex items-center py-2 transition-all duration-300"
                >
                  Login
                </Link>
              </>
