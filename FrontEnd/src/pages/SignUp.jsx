...
const SignUp = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          <h1
            className={
              "text-[#d6482b]text-2xl font-bold md-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl"
            }
          >
            Register
          </h1>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-1 gap-2">
              <label className="text-[16px] text-stone-600">ProfileImage</label>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="Indian Overseas Bank">IOB</option>
                    <option value="Indian Bank">IB</option>
                  ...
                  <input
                    ...
                    placeholder="Bank Account User Name"
            ...
            <button
              className="bg-[#d6482b] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white w-[280px] mx-auto lg:[640px] md-4"
              type="Submit"
              disabled={loading}
            >
              {loading && "Registering..."}
